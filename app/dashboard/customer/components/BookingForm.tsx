 ...
 */
export default function BookingForm({ businessId, preSelectedService, onBookingComplete }: BookingFormProps) {
  const { user } = useUser()
    ...
    <Card className="w-full max-w-4xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedService} onValueChange={(value) => setSelectedService(value as Id<"servicePackages">)}>
            <SelectTrigger>
